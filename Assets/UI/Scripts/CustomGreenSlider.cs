...
public class CustomGreenSlider : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        _slider = _root.Q<SliderInt>("GreenSlider");
    ...
    private void AddElements()
    {
        ...
        _newDragger.name = "NewDraggerGreen";
        _newDragger.AddToClassList("newDraggerGreen");
