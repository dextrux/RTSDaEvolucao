...
public class CustomBlueSlider : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        _slider = _root.Q<SliderInt>("BlueSlider");
    ...
    private void AddElements()
    {
        ...
        _newDragger.name = "NewDraggerBlue";
        _newDragger.AddToClassList("newDraggerBlue");
